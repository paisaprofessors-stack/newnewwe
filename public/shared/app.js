...
const PRODUCT_URL = document.body?.dataset.productUrl || '/products/travis-scott-oversized-tee/';
...
const CART_PRODUCT_FALLBACKS = {
  'mono-tee-01': {
    ...
    image: '/products/travis-scott-oversized-tee/assets/preview1.webp',
    price: 649,
    defaultSize: 'L',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
  ...
  'lunar-black-full-sleeve-01': {
    ...
    image: '/products/lunar-black-full-sleeve-t-shirt/assets/preview1.webp',
    price: 599,
    defaultSize: 'L',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    stockBySize: { S: 4, M: 7, L: 12, XL: 3, XXL: 3 }
  ...
  'built-for-speed-oversized-tee-01': {
    ...
    image: '/products/built-for-speed-oversized-t-shirt/assets/preview1.webp',
    price: 699,
    defaultSize: 'M',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    stockBySize: { S: 4, M: 7, L: 12, XL: 3, XXL: 3 }
...
const renderDetailProduct = () => {
  ...
  const slug = params.get('product') || document.body?.dataset.productSlug || '';
