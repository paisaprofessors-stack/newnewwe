...
const productSlugs = {
  'product 1': 'travis-scott-oversized-tee',
  'product 2': 'lunar-black-full-sleeve-t-shirt',
  'product 3': 'built-for-speed-oversized-t-shirt'
};
const productAsset = (productDir, file) => `/products/${productSlugs[productDir] || productDir}/assets/${file}`;

window.FVRST_PRODUCTS = [
  {
    id: 'mono-tee-01',
    slug: 'travis-scott-oversized-tee',
    detailUrl: '/products/travis-scott-oversized-tee/',
  ...
  },
  {
    ...
    detailUrl: '/products/lunar-black-full-sleeve-t-shirt/',
  ...
  },
  {
    ...
    detailUrl: '/products/built-for-speed-oversized-t-shirt/',
